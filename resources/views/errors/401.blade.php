...
<body>
    <div class="error-card">
        ...
        <div class="error-message">Debe iniciar sesión para acceder a este recurso.</div>
        <a href="{{ route('login') }}" class="btn-error">Iniciar Sesión</a>
